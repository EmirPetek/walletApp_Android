...
class AllTransactionsFragmentCardsAdapter(
    val mContext: Context,
    val cardList: List<CardDTO>,
    val progressBarAllTransactionsCards: ProgressBar
): RecyclerView.Adapter<AllTransactionsFragmentCardsAdapter.CardHolder>(){
    ...
    override fun onBindViewHolder(holder: CardHolder, position: Int) {
        ...
        if (position == itemCount - 1 || cardList.isEmpty()) progressBarAllTransactionsCards.visibility = View.GONE
